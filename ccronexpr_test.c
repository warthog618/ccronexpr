...
void test_expr() {
#ifdef CRON_USE_LOCAL_TIME
    check_next("* 15 11 * * *",     "2019-03-09_11:43:00", "2019-03-10_11:15:00", __LINE__);
#else
    check_next("*/15 * 1-4 * * *",  "2012-07-01_09:53:50", "2012-07-02_01:00:00", __LINE__);
    check_next("*/15 * 1-4 * * *",  "2012-07-01_09:53:00", "2012-07-02_01:00:00", __LINE__);
    check_next("0 */2 1-4 * * *",   "2012-07-01_09:00:00", "2012-07-02_01:00:00", __LINE__);
    check_next("0 */2 * * * *",     "2012-07-01_09:00:00", "2012-07-01_09:02:00", __LINE__);
    check_next("0 */2 * * * *",     "2013-07-01_09:00:00", "2013-07-01_09:02:00", __LINE__);
    check_next("0 */2 * * * *",     "2018-09-14_14:24:00", "2018-09-14_14:26:00", __LINE__);
    check_next("0 */2 * * * *",     "2018-09-14_14:25:00", "2018-09-14_14:26:00", __LINE__);
    check_next("0 */20 * * * *",    "2018-09-14_14:24:00", "2018-09-14_14:40:00", __LINE__);
    check_next("* * * * * *",       "2012-07-01_09:00:00", "2012-07-01_09:00:01", __LINE__);
    check_next("* * * * * *",       "2012-12-01_09:00:58", "2012-12-01_09:00:59", __LINE__);
    check_next("10 * * * * *",      "2012-12-01_09:42:09", "2012-12-01_09:42:10", __LINE__);
    check_next("11 * * * * *",      "2012-12-01_09:42:10", "2012-12-01_09:42:11", __LINE__);
    check_next("10 * * * * *",      "2012-12-01_09:42:10", "2012-12-01_09:43:10", __LINE__);
    check_next("10-15 * * * * *",   "2012-12-01_09:42:09", "2012-12-01_09:42:10", __LINE__);
    check_next("10-15 * * * * *",   "2012-12-01_21:42:14", "2012-12-01_21:42:15", __LINE__);
    check_next("0 * * * * *",       "2012-12-01_21:10:42", "2012-12-01_21:11:00", __LINE__);
    check_next("0 * * * * *",       "2012-12-01_21:11:00", "2012-12-01_21:12:00", __LINE__);
    check_next("0 11 * * * *",      "2012-12-01_21:10:42", "2012-12-01_21:11:00", __LINE__);
    check_next("0 10 * * * *",      "2012-12-01_21:11:00", "2012-12-01_22:10:00", __LINE__);
    check_next("0 0 * * * *",       "2012-09-30_11:01:00", "2012-09-30_12:00:00", __LINE__);
    check_next("0 0 * * * *",       "2012-09-30_12:00:00", "2012-09-30_13:00:00", __LINE__);
    check_next("0 0 * * * *",       "2012-09-10_23:01:00", "2012-09-11_00:00:00", __LINE__);
    check_next("0 0 * * * *",       "2012-09-11_00:00:00", "2012-09-11_01:00:00", __LINE__);
    check_next("0 0 0 * * *",       "2012-09-01_14:42:43", "2012-09-02_00:00:00", __LINE__);
    check_next("0 0 0 * * *",       "2012-09-02_00:00:00", "2012-09-03_00:00:00", __LINE__);
    check_next("* * * 10 * *",      "2012-10-09_15:12:42", "2012-10-10_00:00:00", __LINE__);
    check_next("* * * 10 * *",      "2012-10-11_15:12:42", "2012-11-10_00:00:00", __LINE__);
    check_next("0 0 0 * * *",       "2012-09-30_15:12:42", "2012-10-01_00:00:00", __LINE__);
    check_next("0 0 0 * * *",       "2012-10-01_00:00:00", "2012-10-02_00:00:00", __LINE__);
    check_next("0 0 0 * * *",       "2012-08-30_15:12:42", "2012-08-31_00:00:00", __LINE__);
    check_next("0 0 0 * * *",       "2012-08-31_00:00:00", "2012-09-01_00:00:00", __LINE__);
    check_next("0 0 0 * * *",       "2012-10-30_15:12:42", "2012-10-31_00:00:00", __LINE__);
    check_next("0 0 0 * * *",       "2012-10-31_00:00:00", "2012-11-01_00:00:00", __LINE__);
    check_next("0 0 0 1 * *",       "2012-10-30_15:12:42", "2012-11-01_00:00:00", __LINE__);
    check_next("0 0 0 1 * *",       "2012-11-01_00:00:00", "2012-12-01_00:00:00", __LINE__);
    check_next("0 0 0 1 * *",       "2010-12-31_15:12:42", "2011-01-01_00:00:00", __LINE__);
    check_next("0 0 0 1 * *",       "2011-01-01_00:00:00", "2011-02-01_00:00:00", __LINE__);
    check_next("0 0 0 31 * *",      "2011-10-30_15:12:42", "2011-10-31_00:00:00", __LINE__);
    check_next("0 0 0 1 * *",       "2011-10-30_15:12:42", "2011-11-01_00:00:00", __LINE__);
    check_next("* * * * * 2",       "2010-10-25_15:12:42", "2010-10-26_00:00:00", __LINE__);
    check_next("* * * * * 2",       "2010-10-20_15:12:42", "2010-10-26_00:00:00", __LINE__);
    check_next("* * * * * 2",       "2010-10-27_15:12:42", "2010-11-02_00:00:00", __LINE__);
    check_next("55 5 * * * *",      "2010-10-27_15:04:54", "2010-10-27_15:05:55", __LINE__);
    check_next("55 5 * * * *",      "2010-10-27_15:05:55", "2010-10-27_16:05:55", __LINE__);
    check_next("55 * 10 * * *",     "2010-10-27_09:04:54", "2010-10-27_10:00:55", __LINE__);
    check_next("55 * 10 * * *",     "2010-10-27_10:00:55", "2010-10-27_10:01:55", __LINE__);
    check_next("* 5 10 * * *",      "2010-10-27_09:04:55", "2010-10-27_10:05:00", __LINE__);
    check_next("* 5 10 * * *",      "2010-10-27_10:05:00", "2010-10-27_10:05:01", __LINE__);
    check_next("55 * * 3 * *",      "2010-10-02_10:05:54", "2010-10-03_00:00:55", __LINE__);
    check_next("55 * * 3 * *",      "2010-10-03_00:00:55", "2010-10-03_00:01:55", __LINE__);
    check_next("* * * 3 11 *",      "2010-10-02_14:42:55", "2010-11-03_00:00:00", __LINE__);
    check_next("* * * 3 11 *",      "2010-11-03_00:00:00", "2010-11-03_00:00:01", __LINE__);
    check_next("0 0 0 29 2 *",      "2007-02-10_14:42:55", "2008-02-29_00:00:00", __LINE__);
    check_next("0 0 0 29 2 *",      "2008-02-29_00:00:00", "2012-02-29_00:00:00", __LINE__);
    check_next("0 0 7 ? * MON-FRI", "2009-09-26_00:42:55", "2009-09-28_07:00:00", __LINE__);
    check_next("0 0 7 ? * MON-FRI", "2009-09-28_07:00:00", "2009-09-29_07:00:00", __LINE__);
    check_next("0 30 23 30 1/3 ?",  "2010-12-30_00:00:00", "2011-01-30_23:30:00", __LINE__);
    check_next("0 30 23 30 1/3 ?",  "2011-01-30_23:30:00", "2011-04-30_23:30:00", __LINE__);
    check_next("0 30 23 30 1/3 ?",  "2011-04-30_23:30:00", "2011-07-30_23:30:00", __LINE__);
#endif
}
